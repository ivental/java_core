...
public class RecursionExercisesTest {
        ...
        public void testIsPalindrome() {
            ...
            assertThat(RecursionExercises.isPalindrome("Казак")).isTrue();
            assertThat(RecursionExercises.isPalindrome("Аргентина манит негра")).isTrue();
            assertThat(RecursionExercises.isPalindrome("A man, a plan, a canal, Panama!")).isTrue();
            assertThat(RecursionExercises.isPalindrome("привет")).isFalse();
            assertThat(RecursionExercises.isPalindrome("Здарова")).isFalse();
            assertThat(RecursionExercises.isPalindrome("добрый вечер")).isFalse();
        }
